...
const pets = [{
    ...
    },
    {
        ...
        type: "cat",
        imageUrl: "https://images-na.ssl-images-amazon.com/images/I/71nvIF9KOVL._SX425_.jpg"
    },
    {
        name: "Lucy",
        color: "Red",
...
const petBuilder = (puppybutts) => {
let domString = '';

puppybutts.forEach((pet) => {
        domString += `<div class ="card">`
        domString += `<h2>${pet.name}</h2>`
        domString += `<img src=${pet.imageUrl} alt='Image of ${pet.name}>`
        domString += `</div>` 
    });
